    ...
    <div class="rooms-section">
      <div class="guest-container">
        ...
        <div v-if="!loading && roomTypes.length === 0" class="empty-state">
          ...
          <div class="empty-text">未找到符合条件的房源</div>
        </div>
      </div>
    </div>
...
import { searchRoomTypes, getAvailableRoomTypes } from '@/api/room'
...
const searchForm = ref({
  ...
  guestCount: Number(route.query.guestCount) || 1
})
